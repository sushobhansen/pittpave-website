                ...
                <div>
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Lev.aspx">
                                        <img src="~/Images/People/Faculty/Lev-Khazanovich.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Julie.aspx">
                                        <img src="~/Images/People/Faculty/Julie-Vandenbossche.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Steven.aspx">
                                        <img src="~/Images/People/Faculty/Steven-Sachs.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Naser.aspx">
                                        <img src="~/Images/People/Postdocs/Naser Sharifi.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Lucio.aspx">
                                        <img src="~/Images/People/Postdocs/Lucio Salles de Salles.png" class="card-img" runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="width: 20rem; height: 12rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Sen.aspx">
                                        <img src="~/Images/People/Postdocs/Sushobhan Sen.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Bashear.aspx">
                                        <img src="~/Images/People/Graduate/Bashear El-Hajj.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="CharlesD.aspx">
                                        <img src="~/Images/People/Graduate/Charles Donnelly.jpg" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Haoran.aspx">
                                        <img src="~/Images/People/Graduate/Haoran Li.png" class="card-img" alt="..." runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Kosar.aspx">
                                        <img src="~/Images/People/Graduate/Katelyn Kosar.jpg" class="card-img" alt="..." style="height: 190px; width: auto;" runat="server" /></a>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="ZheWan.aspx">
                                        <img src="~/Images/People/Graduate/Zhe Wan.jpg" class="card-img" alt="Zhe Wan" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="ZheSun.aspx">
                                        <img src="~/Images/People/Graduate/Zhe Sun.jpg" class="card-img" alt="..." runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="KathrynK.aspx">
                                        <img src="~/Images/People/Graduate/Kathryn Kennebeck.jpg" class="card-img" alt="Kathryn Kennebeck" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="PingLyu.aspx">
                                        <img src="~/Images/People/Graduate/Ping Lyu.jpg" class="card-img" alt="Ping Lyu" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="card-deck">
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="ZachBrody.aspx">
                                        <img src="~/Images/People/Graduate/Zachary Brody.jpg" class="card-img" alt="Zachary Brody" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="card mb-3 border-0" style="height: 12rem; width: 20rem;"></div>
                    ...
                    <div class="card-deck">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="KiraKlein.aspx">
                                        <img src="~/Images/People/Undergraduate/Kira Klein.jpg" class="card-img" alt="Kira Klein" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="MMD107.aspx">
                                        <img src="~/Images/People/Undergraduate/megan-darnell.jpg" class="card-img" alt="Kira Klein" runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                    ...
                    <div class="card-deck">
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="JohnDeSantis.aspx">
                                        <img src="~/Images/People/Alumni/JohnDeSantis.jpg" class="card-img" alt="..." runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="card mb-3" style="height: 12rem; width: 20rem;">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <a href="Buettner.aspx">
                                        <img src="~/Images/People/Alumni/Nathanial Buettner.jpg" class="card-img" alt="..." runat="server" style="height: 100px; width: 100px;" /></a>
                                </div>
                                <div class="col-md-8">
