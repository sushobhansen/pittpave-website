<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Julie.aspx.cs" Inherits="People_Julie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" Runat="Server">
    ...
    <div class="row no-gutters">
        <div class="col-sm-2">
            <img src="~/Images/People/Faculty/Julie-Vandenbossche.jpg" class="card-img" alt="..." style="height:12rem; width:auto" runat="server"/>
        </div>
        <div class="col-md-8">

            <div class="card-body">
                <h5 class="card-title">Dr. Julie Vandenbossche</h5>
                <p class="card-text">Title: William Kepler Whiteford Professor</p>
                <p class="card-text"> Email: jmv7@pitt.edu</p>
